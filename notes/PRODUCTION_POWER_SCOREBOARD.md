...
## Current snapshot (2026-09-09 06:11 UTC)

| Metric | Value |
|--------|------:|
| Newdrop merges (7d) | 20 |
| Non-noop cycles/day | 10 today · proj 38.8/day · week_avg 9.5 (bar ≥8) [PASS] |
| Free-desktop agent cap | 8 |
| Theater Active share | 0% (0/1 open) |
| Brain / daemons | CLEAN peer-loop=active improve-loop=active ssh_rc=0 |

Merges: #299 Ops handoff capability-URL noindex (after #297) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/299); #297 Public widget API CORP for COEP hosts (after #294) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/297); #294 Crawl-brief OPTIONS + 405 fail-closed (after #293) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/294); #293 Agent packs hub + embed CORP distribution pins (after #292) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/293); #292 Embed.v2.js distribution crawl pins (after #291) (https://github.com/heyitsmeyourbudlol-lgtm/caas-changelog/pull/292)
